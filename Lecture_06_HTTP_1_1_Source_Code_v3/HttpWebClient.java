...
/**
 * HTTP/1.1 Web Client
 * 对应 Python 版本的 lec-06-prg-02-http-web-client.py
 * 使用 Java 11+ 的 HttpClient（支持 HTTP/1.1）
 */
public class HttpWebClient {
    ...
    public static void main(String[] args) {
        ...
        HttpClient client = HttpClient.newBuilder()
                .version(HttpClient.Version.HTTP_1_1)  // 明确指定使用 HTTP/1.1
        ...
        try {
            ...
            // GET request with query parameters for calculation
            ...
            // POST request with data for calculation
